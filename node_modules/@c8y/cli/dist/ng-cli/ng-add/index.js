...
function ngAdd(options) {
    return async (tree, _context) => {
        ...
        const key = (options === null || options === void 0 ? void 0 : options.project) || Object.keys(json.projects)[0];
...
function addDependencies(tree) {
    ...
    const dependencies = [
        ...
        { name: 'style-loader', version: '3.3.1', type: dependencies_1.NodeDependencyType.Dev }
    ];
...
function angularJson(tree, options) {
    const json = JSON.parse(tree.read('angular.json').toString());
    const key = (options === null || options === void 0 ? void 0 : options.project) || Object.keys(json.projects)[0];
    const project = json.projects[key];
    project.architect.build.builder = '@c8y/cli:build';
    project.architect.serve.builder = '@c8y/cli:dev-server';
