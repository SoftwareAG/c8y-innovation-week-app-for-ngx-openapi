...
class LocaleCompileCommand extends Commands_1.Commands {
    ...
    async action(poPaths, cmd) {
        ...
        this.outputPath = (0, path_1.resolve)(cmd.output || './');
    ...
    async write(files) {
        return await Promise.all(files.map(({ language, json }) => (0, fs_extra_1.writeFile)((0, path_1.resolve)(this.outputPath, `${language}.json`), json)));
    }
}
