...
class Application {
    ...
    get branding() {
        ...
        if (brandingEntry === false) {
            return false;
        }
        return brandingEntry
            ? path.resolve(brandingEntry)
            : BuildDefaults_1.BUILD_DEFAULTS.DEFAULT_BRANDING_PATH;
    }
    set branding(value) {
    ...
    async build(env) {
        ...
        const compilerRun = (0, util_1.promisify)(this.compiler.run.bind(this.compiler));
