...
class DevServer {
    ...
    startDevServer(apps, staticFolders = []) {
        ...
        this.expressApp.use(new RegExp(doProxyRegexStr, 'i'), (0, http_proxy_middleware_1.createProxyMiddleware)(this.config.proxy));
    ...
    addAdditionalProxyServer() {
        if (this.customProxyPaths !== true && this.customProxyPaths) {
            ...
            this.expressApp.use(additionalProxyRegex, (0, http_proxy_middleware_1.createProxyMiddleware)(Object.assign(Object.assign({}, this.config.proxy), { ws: false })));
        }
    }
    /**
     ...
     */
    redirectRootRequest(req, res, _next) {
    ...
    collectMFRemotesForShell(applications) {
        ...
        const applicationsExports = applications.map(app => ({
            [app.contextPath]: (0, lodash_1.get)(app, 'options.exports', []).map(remoteExport => remoteExport.module)
        }));
