...
function configFactory(extraConfigs = []) {
    return function config(env) {
        ...
        return [
            ...
            const mergeFn = configFn.mergeFn || webpack_merge_1.merge;
            return mergeFn(finalConfig, configFn(env));
        }, {});
    };
    function getExtraWebpackConfigFromEnv(env) {
        if (env.extraWebpackConfig) {
            const extraWebPackConfig = require((0, path_1.resolve)(process.cwd(), env.extraWebpackConfig));
