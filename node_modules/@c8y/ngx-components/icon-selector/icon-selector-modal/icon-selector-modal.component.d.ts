...
export declare class IconSelectorModalComponent {
    private bsModal;
    title: string;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IconSelectorModalComponent, "c8y-icon-selector-modal", never, {}, {}, never, never, false, never>;
}
