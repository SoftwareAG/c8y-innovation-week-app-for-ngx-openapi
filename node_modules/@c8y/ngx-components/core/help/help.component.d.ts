...
export declare class HelpComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<HelpComponent, "c8y-help", never, { "src": "src"; "isCollapsed": "isCollapsed"; "priority": "priority"; "icon": "icon"; }, {}, never, never, false, never>;
}
