...
export declare class TypeaheadTypeComponent extends FieldType implements OnInit {
    private cdRef;
    ...
    labelProp: string;
    match: boolean;
    placeholder$: import("rxjs").Observable<any>;
    defaultPlaceholder$: import("rxjs").Observable<any>;
    private valueProps;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TypeaheadTypeComponent, "c8y-typeahead-type", never, {}, {}, never, never, false, never>;
}
