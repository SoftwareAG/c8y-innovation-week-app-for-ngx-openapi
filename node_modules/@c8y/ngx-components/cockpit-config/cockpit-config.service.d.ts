...
export declare class CockpitConfigService {
    ...
    constructor(navigatorService: NavigatorService, tabsService: TabsService, searchService: SearchService, assetNodeService: AssetNodeService, inventoryService: InventoryService, appState: AppStateService, optionsService: OptionsService, permissions: Permissions, moduleConfig: AssetNavigatorConfig);
    init(): void;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<CockpitConfigService, [null, null, null, null, null, null, null, null, { optional: true; }]>;
