...
msgstr "\"檢查用戶許可權\" 部分允許您驗證為選定的設備用戶授予的許可權，這些許可權還可以從父設備繼承或指派給全域角色。\"授予許可權\" 部分允許您檢查和管理設備的許可權。"
...
msgstr "在上述規則中選取的角色將在每次登錄時重新指派給用戶，其他角色將保持不變"
...
msgstr "您即將重置此儀錶板。對儀錶板的所有更改都將丟失，無法恢復。是否要繼續？"
