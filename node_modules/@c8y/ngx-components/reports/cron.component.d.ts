...
export declare class CronComponent implements OnInit {
    private cronService;
    cronIn: string;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CronComponent, "cron", never, { "cronIn": "cronIn"; }, { "emitter": "emitter"; }, never, never, false, never>;
}
