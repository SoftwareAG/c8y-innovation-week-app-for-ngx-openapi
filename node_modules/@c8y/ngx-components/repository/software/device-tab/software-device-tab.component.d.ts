...
import { AdvancedSoftwareService, DeviceSoftware, DeviceSoftwareChange, RepositoryService } from '@c8y/ngx-components/repository/shared';
...
export declare class SoftwareDeviceTabComponent implements OnInit {
    ...
    constructor(route: ActivatedRoute, repository: RepositoryService, inventory: InventoryService, deviceSoftwareService: DeviceSoftwareService, advancedSoftwareService: AdvancedSoftwareService);
