...
export declare class ConfigurationPreviewComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ConfigurationPreviewComponent, "c8y-device-configuration-preview", never, { "device": "device"; "configurationType": "configurationType"; "configSnapshot": "configSnapshot"; "canSaveSnapshot": "canSaveSnapshot"; "actionButtonText": "actionButtonText"; "actionButtonIcon": "actionButtonIcon"; "isLegacy": "isLegacy"; "operationToTrigger": "operationToTrigger"; }, {}, never, never, false, never>;
}
