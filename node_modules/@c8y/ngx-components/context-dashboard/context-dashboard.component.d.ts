...
import { ActionBarService, AlertService, BreadcrumbItem, DashboardChange, DashboardChildChange, DashboardSettings, DynamicComponentDefinition, GainsightService, ModalService, Widget, WidgetChange } from '@c8y/ngx-components';
...
export declare class ContextDashboardComponent implements OnInit, OnDestroy {
     ...
     */
    updateDashboardChildren(child: DashboardChildChange | DashboardChange): Promise<IManagedObject>;
    /**
    ...
    private canCopyDashboard;
    private validDashboardChildren;
    static ɵfac: i0.ɵɵFactoryDeclaration<ContextDashboardComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<ContextDashboardComponent, "c8y-context-dashboard", never, { "name": "name"; "childrenClasses": "childrenClasses"; "context": "context"; "setTitle": "setTitle"; "disabled": "disabled"; "defaultWidgets": "defaultWidgets"; "canCopy": "canCopy"; "canDelete": "canDelete"; "isLoading": "isLoading"; "breadcrumbSettings": "breadcrumbSettings"; "showContextHelpButton": "showContextHelpButton"; "translateWidgetTitle": "translateWidgetTitle"; }, {}, never, never, false, never>;
}
