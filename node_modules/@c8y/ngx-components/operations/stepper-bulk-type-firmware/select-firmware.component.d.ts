...
export declare class SelectFirmwareComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SelectFirmwareComponent, "c8y-select-firmware-step", never, { "selected": "selected"; }, { "firmware": "firmware"; }, never, never, false, never>;
}
