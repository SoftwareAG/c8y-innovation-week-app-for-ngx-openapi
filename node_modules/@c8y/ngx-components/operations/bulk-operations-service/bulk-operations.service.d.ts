 ...
 */
export declare function hookListBulkType(type: GenericHookType<OperationType>, options?: Partial<HookOptions>): import("@angular/core").ValueProvider | import("@angular/core").ClassProvider | import("@angular/core").ExistingProvider;
