...
export declare class DatapointSelectionListComponent implements ControlValueAccessor, Validator, OnInit, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatapointSelectionListComponent, "c8y-datapoint-selection-list", never, { "actions": "actions"; "allowDragAndDrop": "allowDragAndDrop"; "config": "config"; "defaultFormOptions": "defaultFormOptions"; "maxActiveCount": "maxActiveCount"; "minActiveCount": "minActiveCount"; "resolveContext": "resolveContext"; "listTitle": "listTitle"; }, { "isValid": "isValid"; "change": "change"; }, never, [".alert"], false, never>;
}
