...
class DataBrokerSubscriptionsService {
    ...
    getBrokerSubscriptionsList() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.inventoryService.list(this.filters)).data;
        });
    }
    /**
    ...
    remove(subscription) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.inventoryService.update(pick(subscription, ['id', this.FRAGMENT_TYPE, brokerSourceRenamed]));
        });
    }
    setStatus(subscription, enabled) {
        return __awaiter(this, void 0, void 0, function* () {
            const userData = (yield this.userService.update({
    ...
    listPendingBrokerSubscriptions() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.deviceRegistrationService.list({
                pageSize: 2000,
                withTotalPages: true
            })).data;
        });
    ...
    accept(code) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.deviceRegistrationService.accept(code)).data;
        });
    }
    /**
    ...
    discard(code) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.deviceRegistrationService.delete(code);
        });
    }
    /**
    ...
    create(code) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.deviceRegistrationService.create({
                id: code,
    ...
    convertToViewModel(subscriptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const viewModelSubscriptions = subscriptions.map((subscription) => __awaiter(this, void 0, void 0, function* () {
                const { data: userDetails } = yield this.userService.detail(subscription.owner);
                return {
