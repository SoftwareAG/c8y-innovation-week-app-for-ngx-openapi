...
class ServicesBreadcrumbFactory {
    ...
    get(route) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((context === ViewContext.Service || (routeConfig === null || routeConfig === void 0 ? void 0 : routeConfig.context) === ViewContext.Service) &&
                !!this.contextData) {
                const serviceMO = (_a = (yield this.inventoryService.detail(this.contextData, { withParents: true }))) === null || _a === void 0 ? void 0 : _a.data;
                const breadcrumb = { items: [] };
                const breadcrumbItems = [];
                const device = (_c = (_b = serviceMO === null || serviceMO === void 0 ? void 0 : serviceMO.additionParents) === null || _b === void 0 ? void 0 : _b.references[0]) === null || _c === void 0 ? void 0 : _c.managedObject;
                if (device) {
