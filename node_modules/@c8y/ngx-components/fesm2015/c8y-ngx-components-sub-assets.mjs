...
import { Injectable, Component, InjectionToken, Inject, EventEmitter, Input, Output, ViewChild, HostListener, NgModule, Optional, TemplateRef } from '@angular/core';
import * as i3 from '@c8y/ngx-components';
import { GroupFragment, gettext, BaseColumn, getBasicInputArrayFormFieldConfig, DataGridService, C8yStepper, CoreModule, hookRoute, Status, AbstractConfigurationStrategy, DATA_GRID_CONFIGURATION_CONTEXT, DATA_GRID_CONFIGURATION_CONTEXT_PROVIDER, UserPreferencesConfigurationStrategy, DATA_GRID_CONFIGURATION_STRATEGY, DataGridComponent, ViewContext } from '@c8y/ngx-components';
...
class AssetTypeCellRendererComponent {
    ...
    ngOnInit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.iconTitle = this.getIconTitle(yield this.groupIcon);
        });
    }
    getIconTitle(icon) {
        if (this.isAsset) {
...
class SubAssetsService extends DataGridService {
    ...
    getData(columns, pagination, parentReference, baseQuery = {}, text = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const isRoot = !parentReference;
            if (isRoot) {
                const query = this.buildCombinedRootQueryFilter(columns, pagination, baseQuery);
                return this.assetNodeService.getRootNodes(Object.assign(Object.assign(Object.assign({}, pagination), (text && { text })), { query }));
            }
            const filters = Object.assign(Object.assign({}, this.getAssetsFilters(columns, pagination, baseQuery, text)), { withParents: false });
    ...
    getCount(columns, pagination, parentReference, baseQuery = {}, text = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const filters = !parentReference
                ? Object.assign({ query: this.buildCombinedRootQueryFilter(columns, pagination, baseQuery) }, defaultFilters) : Object.assign(Object.assign({}, this.getAssetsFilters(columns, pagination, baseQuery, text)), defaultFilters);
    ...
    getAssetsFilters(columns, pagination, baseQuery, text) {
        ...
        return Object.assign(Object.assign({}, (text && { text })), { query: this.queriesUtil.buildQuery(query), pageSize: pagination.pageSize || this.DEFAULT_PAGE_SIZE, currentPage: pagination.currentPage, withTotalPages: true });
    }
}
...
class AssetPropertiesComponent {
    ...
    loadAsset() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                this.properties = this.keepOrder((_b = (_a = this.assetType) === null || _a === void 0 ? void 0 : _a.c8y_IsAssetType) === null || _b === void 0 ? void 0 : _b.properties, this.properties);
            }
            catch (ex) {
                console.warn(ex);
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const mo of managedObjects) {
                if (mo.c8y_JsonSchema) {
                    const [item] = yield this.parseItem(mo, mo.c8y_JsonSchema.properties, this.asset);
    ...
    deleteTitleFromMOJsonSchema(mo) {
        var _a, _b;
        const schemaProperties = (_a = mo === null || mo === void 0 ? void 0 : mo.c8y_JsonSchema) === null || _a === void 0 ? void 0 : _a.properties;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const key of keys) {
                ...
                items.push({
                    ...
                    file,
                    complex: type === 'object'
                        ? yield this.parseItem(mo, properties[key].properties, value)
                        : undefined,
                    isEdit: false,
    ...
    save(propertyValue, prop) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const updatedAsset = Object.assign({ id: this.asset.id }, propertyValue);
    ...
    setItemRequired(item, mo) {
        ...
        const isAssetPropertyRequired = !!((_c = (_b = (_a = this.assetType) === null || _a === void 0 ? void 0 : _a.c8y_IsAssetType) === null || _b === void 0 ? void 0 : _b.properties.find(p => p.id === mo.id)) === null || _c === void 0 ? void 0 : _c.isRequired);
        if (!isAssetPropertyRequired) {
            return;
        }
        const isComplexProperty = !!((_d = item === null || item === void 0 ? void 0 : item.complex) === null || _d === void 0 ? void 0 : _d.length);
        if (isComplexProperty) {
            const complexProperty = (_f = (_e = item.jsonSchema) === null || _e === void 0 ? void 0 : _e.properties) === null || _f === void 0 ? void 0 : _f[mo.c8y_JsonSchema.key];
...
class SmartGroupGridConfigurationStrategy extends AbstractConfigurationStrategy {
    ...
    getConfig$(context) {
        var _a, _b, _c;
        const group = cloneDeep((_a = this.retrieveContext(context)) === null || _a === void 0 ? void 0 : _a.group);
        if ((_c = (_b = group === null || group === void 0 ? void 0 : group.c8y_DeviceColumnsConfig) === null || _b === void 0 ? void 0 : _b.columns) === null || _c === void 0 ? void 0 : _c.length) {
            group.c8y_DeviceColumnsConfig.columns = group.c8y_DeviceColumnsConfig.columns.map(column => {
                delete column.filter;
                return column;
            });
        }
        return of(group === null || group === void 0 ? void 0 : group.c8y_DeviceColumnsConfig);
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: SmartGroupGridConfigurationStrategy, decorators: [{
        ...
        return [{ type: i3.UserPreferencesConfigurationStrategy }, { type: undefined, decorators: [{
                        type: Inject,
...
class SubAssetsGridConfigurationStrategy extends AbstractConfigurationStrategy {
    ...
    getStrategy(ctx) {
        ...
        return !!(context === null || context === void 0 ? void 0 : context.group) &&
            this.assetNodeService.isDynamicGroup(context === null || context === void 0 ? void 0 : context.group) &&
            ((_a = context === null || context === void 0 ? void 0 : context.group) === null || _a === void 0 ? void 0 : _a.c8y_DeviceColumnsConfig)
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: SubAssetsGridConfigurationStrategy, decorators: [{
        ...
        return [{ type: i3.UserPreferencesConfigurationStrategy }, { type: SmartGroupGridConfigurationStrategy }, { type: i5.AssetNodeService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DATA_GRID_CONFIGURATION_CONTEXT]
                    }, {
                        type: Optional
...
class SubAssetsGridComponent {
    ...
    set columns(value) {
        this._columns = value !== null && value !== void 0 ? value : this.subAssetsGridService.getDefaultColumns();
    }
...
class GroupInfoComponent {
    ...
    ngOnChanges(changes) {
        return __awaiter(this, void 0, void 0, function* () {
            if (changes.group) {
                ...
                this.groupIcon = yield this.assetNodeService.icon(this.group);
    ...
    updateGroup(partialGroup) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield this.inventory.update(group)).data;
        });
    }
    updateSmartGroup(partialGroup) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!c8y_DeviceQueryString) {
                return (yield this.smartGroupsService.update(group)).data;
            }
            try {
                ...
                yield this.isQueryExecutable(c8y_DeviceQueryString);
            }
            catch (error) {
                throw Error(error);
            }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: GroupInfoComponent, decorators: [{
        ...
        return [{ type: i2.InventoryService }, { type: SubAssetsService }, { type: i2.SmartGroupsService }, { type: i3.AlertService }, { type: i1.TranslateService }, { type: i3.ModalService }, { type: i5.AssetNodeService }, { type: i3.AssetTypesService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [SUB_ASSETS_CONFIG]
                    }] }];
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: GroupsComponent, decorators: [{
        ...
        return [{ type: i3.Permissions }, { type: SubAssetsService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [SUB_ASSETS_CONFIG]
                    }] }];
    } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: SubAssetsComponent, decorators: [{
        ...
        return [{ type: i3$2.ActivatedRoute }, { type: SubAssetsService }, { type: i3.ContextRouteService }, { type: i3.Permissions }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [SUB_ASSETS_CONFIG]
                    }] }];
    } });
            ...
            providers: [
                {
                    ...
                    useValue: Object.assign(Object.assign({}, defaultModuleConfig), config)
                }
            ]
        };
    }
