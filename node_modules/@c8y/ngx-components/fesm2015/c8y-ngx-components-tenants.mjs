        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.navs.length) {
                ...
                if (subtenantsNavigatorNode !== false) {
                    this.navs.push(new NavigatorNode(Object.assign({ parent: {
                            label: gettext('Tenants'),
                            icon: 'c8y-layers'
                        }, label: gettext('Subtenants'), icon: 'c8y-sub-tenants', path: 'tenants', routerLinkExact: false, priority: 4000, hidden: !canActivateTenantList }, (subtenantsNavigatorNode === true ? {} : subtenantsNavigatorNode))));
                }
            }
            return this.navs;
        });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: TenantsNavigationFactory, decorators: [{
        ...
        return [{ type: TenantListGuard }, { type: undefined, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
