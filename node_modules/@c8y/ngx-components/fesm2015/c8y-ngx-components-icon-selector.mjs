...
class IconSelectorComponent {
    ...
    loadIconDefinitions() {
        return __awaiter(this, void 0, void 0, function* () {
            const { allIcons } = yield import('@c8y/ngx-components/icon-selector/icons');
            return allIcons;
        });
    }
        ...
        if (searchTerm) {
            ...
            for (const category of iconCategories) {
                ...
                if (matchingIcons.length) {
                    matchingCategories.push(Object.assign(Object.assign({}, clone(category)), { icons: matchingIcons }));
                }
            }
