...
Ng1ActionBarFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1ActionBarFactoryService, deps: [{ token: BridgeService }], target: i0.ɵɵFactoryTarget.Injectable });
...
Ng1ActionFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1ActionFactoryService, deps: [{ token: BridgeService }, { token: i2.TabsService }], target: i0.ɵɵFactoryTarget.Injectable });
...
Ng1BreadcrumbFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1BreadcrumbFactoryService, deps: [{ token: BridgeService }], target: i0.ɵɵFactoryTarget.Injectable });
...
Ng1NodesFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1NodesFactoryService, deps: [{ token: BridgeService }], target: i0.ɵɵFactoryTarget.Injectable });
Ng1NodesFactoryService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1NodesFactoryService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1NodesFactoryService, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: BridgeService }]; } });
...
Ng1TabsFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1TabsFactoryService, deps: [{ token: BridgeService }], target: i0.ɵɵFactoryTarget.Injectable });
Ng1TabsFactoryService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1TabsFactoryService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1TabsFactoryService, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: BridgeService }]; } });
...
Ng1DocsFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1DocsFactoryService, deps: [{ token: BridgeService }], target: i0.ɵɵFactoryTarget.Injectable });
...
UpgradeModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: UpgradeModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
UpgradeModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.7", ngImport: i0, type: UpgradeModule, imports: [RouterModule, UpgradedServicesModule] });
UpgradeModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: UpgradeModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: UpgradeModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [RouterModule, UpgradedServicesModule],
                    exports: [],
...
const emptyStateComponent = downgradeComponent({ component: EmptyStateComponent });
const datapointSelectionListComponent = downgradeComponent({
    component: DatapointSelectionListComponent
});
const paginationComponent = downgradeComponent({ component: PaginationComponent });
const rolesAssetTreeComponent = downgradeComponent({ component: RolesAssetTreeComponent });
const passwordInputComponent = downgradeComponent({ component: PasswordInputComponent });
...
ServerMessagesService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: ServerMessagesService, deps: [{ token: i1.TranslateService }, { token: HOOK_PATTERN_MESSAGES }], target: i0.ɵɵFactoryTarget.Injectable });
ServerMessagesService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: ServerMessagesService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: ServerMessagesService, decorators: [{
            type: Injectable
        }], ctorParameters: function () {
        return [{ type: i1.TranslateService }, { type: undefined, decorators: [{
                        type: Inject,
...
const UPGRADE_ROUTES = [{ path: '**', component: EmptyComponent }];
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: DashboardBridgeService, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: undefined }, { type: i0.NgZone }, { type: i1$1.Router }, { type: i2$1.ContextDashboardService }]; } });
...
WidgetComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: WidgetComponent, deps: [{ token: i2.WidgetsDashboardComponent, optional: true }, { token: DashboardBridgeService }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: WidgetComponent, decorators: [{
        ...
        return [{ type: i2.WidgetsDashboardComponent, decorators: [{
                        type: Optional
                    }] }, { type: DashboardBridgeService }, { type: i0.ElementRef }];
    } });
...
DeviceSelectorComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: DeviceSelectorComponent, deps: [{ token: DashboardBridgeService }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Component });
DeviceSelectorComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.2.7", type: DeviceSelectorComponent, selector: "c8y-device-selector-legacy", ngImport: i0, template: '', isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: DeviceSelectorComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: DashboardBridgeService }, { type: i0.ElementRef }]; } });
...
class Ng1ComponentFactoryService {
    ...
    getComponents() {
        return __awaiter(this, void 0, void 0, function* () {
            const ng1Components = yield this.bridge.ng1Components.list();
            const components = ng1Components.map(cmp => {
                var _a, _b, _c, _d, _e, _f;
                const resolve = {};
                if (((_a = cmp.options) === null || _a === void 0 ? void 0 : _a.datapointAttributes) && Array.isArray((_b = cmp.options) === null || _b === void 0 ? void 0 : _b.datapointAttributes)) {
                    (_c = cmp.options) === null || _c === void 0 ? void 0 : _c.datapointAttributes.forEach(attribute => (resolve[attribute] = DynamicDatapointsResolver));
                }
                if (((_d = cmp.options) === null || _d === void 0 ? void 0 : _d.managedObjectAttributes) &&
                    Array.isArray((_e = cmp.options) === null || _e === void 0 ? void 0 : _e.managedObjectAttributes)) {
                    (_f = cmp.options) === null || _f === void 0 ? void 0 : _f.managedObjectAttributes.forEach(attribute => (resolve[attribute] = DynamicManagedObjectResolver));
                }
                const data = {
...
Ng1ComponentFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1ComponentFactoryService, deps: [{ token: DashboardBridgeService }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: Ng1ComponentFactoryService, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: DashboardBridgeService }]; } });
...
export { AuthBridgeService, BridgeService, DashboardBridgeService, DashboardUpgradeModule, DeviceSelectorComponent, HybridAppModule, Ng1ActionBarFactoryService, Ng1ActionFactoryService, Ng1BreadcrumbFactoryService, Ng1ComponentFactoryService, Ng1DocsFactoryService, Ng1NodesFactoryService, Ng1SmartRulesService, Ng1TabsFactoryService, SmartRulesServiceFactory, UPGRADE_ROUTES, UpgradeModule, WidgetComponent, authBridgeServiceFactory, authBridgeServiceProvider, bridgeServiceFactory, bridgeServiceProvider, dashboardBridgeFactory, ng1Modules, smartRulesServiceProvider };
//# sourceMappingURL=c8y-ngx-components-upgrade.mjs.map
