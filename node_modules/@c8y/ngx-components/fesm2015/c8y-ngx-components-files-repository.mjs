...
class FilesRepositoryService {
    ...
    getData(columns, pagination, searchText = '') {
        return __awaiter(this, void 0, void 0, function* () {
            // build filters based on columns and pagination
            const filters = Object.assign({ text: searchText }, this.getFilters(columns, pagination));
    ...
    getCount(columns, pagination) {
        return __awaiter(this, void 0, void 0, function* () {
            const filters = Object.assign(Object.assign({}, this.getFilters(columns, pagination)), { 
...
class FilesRepositoryComponent {
    ...
    onDataSourceModifier(dataSourceModifier) {
        return __awaiter(this, void 0, void 0, function* () {
            const { res, data, paging } = yield this.filesRepositoryService.getData(dataSourceModifier.columns, dataSourceModifier.pagination, dataSourceModifier.searchText);
            const filteredSize = yield this.filesRepositoryService.getCount(dataSourceModifier.columns, dataSourceModifier.pagination);
            const size = yield this.filesRepositoryService.getTotal();
    ...
    onDeleteItems(selectedItemsIds) {
        return __awaiter(this, void 0, void 0, function* () {
            const dataGridDataSourceData = yield this.dataGrid.dataSource.data$.pipe(take(1)).toPromise();
    ...
    deleteItemsWithConfirmation(selectedItemsIds, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.confirmItemsDeletion(options);
                this.isLoading = true;
    ...
    confirmItemsDeletion({ title, body }) {
        return __awaiter(this, void 0, void 0, function* () {
            const status = Status.DANGER;
            const labels = { ok: gettext('Delete'), cancel: gettext('Cancel') };
            yield this.modalService.confirm(title, body, status, labels);
        });
    }
}
