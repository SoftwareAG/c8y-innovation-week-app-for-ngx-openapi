...
class WelcomeToDeviceManagementComponent {
    ...
    createQuickLinkToNavNode(navNodePathLabels, quickLinkOverrides = {}) {
        ...
        const quickLink = Object.assign(Object.assign({ icon: navNode.icon, label: navNode.label }, quickLinkOverrides), { click: () => __awaiter(this, void 0, void 0, function* () {
                navNode.parents[0].open = true;
                yield this.router.navigateByUrl(navNode.path);
            }) });
