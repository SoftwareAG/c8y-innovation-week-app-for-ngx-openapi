...
class LicenseViewComponent {
    ...
    ngOnInit() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.fetchClient.fetch(this.url);
...
class LicenseConfirmModalComponent {
    ...
    ngOnInit() {
        ...
        const uniqByUrl = uniqBy(allLicenses, 'url').map(license => (Object.assign(Object.assign({}, license), { pluginName: allLicenses
