...
class ThreeDRotationComponent {
    ...
    get canvas() {
        var _a;
        return (_a = this.canvasRef) === null || _a === void 0 ? void 0 : _a.nativeElement;
    }
    ngOnInit() {
        ...
        this.renderSubscription = combineLatest([
            ...
            .subscribe(([three, model, cameraType]) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.renderer) {
                yield this.setupRenderer(three);
            }
            this.render();
        }));
    }
    ...
    loadModel(modelObj, three) {
        return __awaiter(this, void 0, void 0, function* () {
            const loader = new three.ObjectLoader();
            const parsedModel = yield loader.parse(modelObj);
            return parsedModel;
        });
    }
    setupRenderer(three) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { OrbitControls } = yield loadOrbitControls();
...
class ThreeDRotationWidgetViewComponent {
    ...
    onConfigChange() {
        var _a, _b, _c, _d;
        if ((_a = this.config.device) === null || _a === void 0 ? void 0 : _a.id) {
            this.deviceId$.next(`${this.config.device.id}`);
        }
        else if ((_c = (_b = this.dashboard) === null || _b === void 0 ? void 0 : _b.context) === null || _c === void 0 ? void 0 : _c.id) {
            this.deviceId$.next(`${(_d = this.dashboard.context) === null || _d === void 0 ? void 0 : _d.id}`);
        }
    ...
    getModelUrl(model) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (model === 'box.min.json') {
                return yield loadBoxModel();
            }
            else {
                return yield loadPhoneModel();
            }
        });
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: ThreeDRotationWidgetViewComponent, decorators: [{
        ...
        return [{ type: i2.MeasurementRealtimeService }, { type: i2$1.ContextDashboardComponent, decorators: [{
                        type: Optional
                    }] }];
