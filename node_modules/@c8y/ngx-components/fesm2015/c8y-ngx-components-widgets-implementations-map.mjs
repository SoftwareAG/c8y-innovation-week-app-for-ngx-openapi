...
class MapEventInfoComponent {
    ...
    ngOnChanges() {
        return __awaiter(this, void 0, void 0, function* () {
            this.loading = true;
            const { data } = yield this.eventService.list({
                dateFrom: '1970-01-01',
...
class MapWidgetConfigComponent {
    ...
    ngOnInit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.formConfig = Object.assign(Object.assign(Object.assign({}, this.formConfig), this.config.mapConfig), { disablePan: false });
            yield this.updateAsset();
        });
    }
    ngOnChanges(changes) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    zoomLevelChanged() {
        this.config.mapConfig = Object.assign(Object.assign({}, this.config.mapConfig), { zoomLevel: this.formConfig.zoomLevel });
    }
    changeCenter() {
        this.config.mapConfig = Object.assign(Object.assign({}, this.formConfig), { center: this.formConfig.center });
    }
    onPreviewZoomStart() {
    ...
    openIconSelector() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.config.mapConfig = Object.assign(Object.assign({}, this.config.mapConfig), { icon });
            }
            catch (_a) {
                // nothing to do
            }
    ...
    updateAsset() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data, paging } = yield this.mapService.getAllPositionsMOs(this.config.device);
            this.assets = data;
...
class MapWidgetComponent {
    ...
    startFollow(context) {
        var _a;
        if (context.id !== ((_a = this.rootNode) === null || _a === void 0 ? void 0 : _a.id)) {
            this.rootNode = context;
        }
        this.mapConfig = Object.assign(Object.assign({}, this.config.mapConfig), { follow: true, realtime: true });
    }
    stopFollow() {
        this.mapConfig = Object.assign(Object.assign({}, this.config.mapConfig), { follow: false });
