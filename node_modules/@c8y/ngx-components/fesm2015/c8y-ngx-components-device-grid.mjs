...
class DeviceGridService extends DataGridService {
    ...
    getData(columns, pagination, query = {}, withChildren = false, text = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const filters = Object.assign(Object.assign({}, this.getDevicesFilters(columns, pagination, query, false, text)), { withGroups: true, withChildren });
    ...
    getCount(columns, pagination, query = {}, text = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const filters = Object.assign(Object.assign({}, this.getDevicesFilters(columns, pagination, query, false, text)), { pageSize: 1, currentPage: 1 });
    ...
    getDevicesFilters(columns, pagination, query, childDeviceFilters, text) {
        return Object.assign(Object.assign(Object.assign({}, (childDeviceFilters
            ? { query: this.getDeviceQueryString(columns, query) }
            : { q: this.getDeviceQueryString(columns, query) })), (text && { text })), { pageSize: pagination.pageSize, currentPage: pagination.currentPage, withChildren: false, withTotalPages: true });
    }
}
    ...
    onDataSourceModifier(dataSourceModifier) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.childDeviceGrid) {
                ...
                const { res, data, paging } = yield this.deviceGridService.getData(dataSourceModifier.columns, dataSourceModifier.pagination, this.baseQuery, this.withChildren, dataSourceModifier.searchText);
                filteredSize = yield this.deviceGridService.getCount(dataSourceModifier.columns, dataSourceModifier.pagination, this.baseQuery, dataSourceModifier.searchText);
