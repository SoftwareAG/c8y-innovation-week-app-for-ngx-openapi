...
class ReplaceDeviceService {
    ...
    constructor(inventory, identity, audit, event, user, appState, breadcrumbService, alert) {
        ...
        this.externalIdsWithSelection$ = combineLatest([
            this.externalIds$.pipe(map(result => result === null || result === void 0 ? void 0 : result.data), map(externalIds => externalIds === null || externalIds === void 0 ? void 0 : externalIds.map(id => ({ id, selected: true })))),
            this.checkExternalId$
        ]).pipe(scan((acc, val) => {
            const [selectedIds, lastAction] = acc;
            const [_, checkAction] = val;
            if (!((lastAction === null || lastAction === void 0 ? void 0 : lastAction.checked) === (checkAction === null || checkAction === void 0 ? void 0 : checkAction.checked) &&
                this.areExtIdsEqual(lastAction === null || lastAction === void 0 ? void 0 : lastAction.id, checkAction === null || checkAction === void 0 ? void 0 : checkAction.id))) {
    ...
    retryStep(step) {
        this.steps.forEach(s => {
            if ((s.label === (step === null || step === void 0 ? void 0 : step.label) || !step) &&
        ...
        this.steps = [
            {
                ...
                action: (context) => {
                    ...
                    return forkJoin([
                        ...
                        })).pipe(map(result => { var _a; return ((_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.length) === 1; })),
                        from(this.inventory.detail(replacementDeviceId)).pipe(map(result => result === null || result === void 0 ? void 0 : result.data)),
                        from(this.identity.list(deviceToReplace.id)).pipe(map(result => result === null || result === void 0 ? void 0 : result.data))
            ...
            },
            {
                ...
                action: (context) => {
                    ...
                    return forkJoin(newExternalIds
                        .map(extId => (Object.assign(Object.assign({}, pick(extId, ['type', 'externalId'])), { managedObject: Object.assign({}, pick(deviceToReplace, ['id'])) })))
            ...
            },
            {
                ...
                action: (context) => {
                    ...
                    return (oldExternalIds === null || oldExternalIds === void 0 ? void 0 : oldExternalIds.length)
    ...
    executeStep(step) {
        return pipe(tap((ctx) => (step.state = (step === null || step === void 0 ? void 0 : step.skip) || ctx.skip ? step.state : REPLACE_DEVICE_STEP_STATE.EXECUTING)), concatMap((ctx) => {
            var _a;
            if (!step.context && !ctx.skip) {
                step.context = cloneDeep(ctx);
            }
            const context = cloneDeep((_a = step.seed) !== null && _a !== void 0 ? _a : ctx);
            return (step === null || step === void 0 ? void 0 : step.skip) || ctx.skip
                ? of(context)
                : toObservable(this.unwrapStepAction(context, step.action)).pipe(tap(result => (step.state = isValidReplaceDeviceStepState(result)
                    ...
                    var _a;
                    if (typeof ((_a = step.info) === null || _a === void 0 ? void 0 : _a.getMessage) === 'function') {
    ...
    removeBreadcrumbs() {
        this.breadcrumbService.state.forEach(bc => { var _a; return (_a = bc.items) === null || _a === void 0 ? void 0 : _a.pop(); });
        this.breadcrumbService.refresh();
    }
    areExtIdsEqual(idA, idB) {
        return (idA === null || idA === void 0 ? void 0 : idA.type) === (idB === null || idB === void 0 ? void 0 : idB.type) && (idA === null || idA === void 0 ? void 0 : idA.externalId) === (idB === null || idB === void 0 ? void 0 : idB.externalId);
    }
    extIdsToString(extnernalIds) {
        return extnernalIds === null || extnernalIds === void 0 ? void 0 : extnernalIds.map(id => `${id.externalId} [${id.type}]`).join(', ');
    }
    toError(err) {
        const { data, res, message } = err;
        let text = (data === null || data === void 0 ? void 0 : data.message) || message;
        let detailedData;
        if (data) {
...
class ReplaceDeviceWizardComponent {
    constructor(replaceDeviceService, deviceGridService, modal) {
        ...
        this.baseQuery$ = this.replaceDeviceService.deviceToReplace$.pipe(map(device => ({
            __not: {
                id: {
                    __eq: device === null || device === void 0 ? void 0 : device.id
                }
            }
        })));
    ...
    replace() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.modal.confirm(gettext('Replace device'), gettext('You are about to replace a device. When the process is finished, the replacement device and its data will be deleted. Do you want to proceed?'), Status.DANGER, { ok: gettext('Replace'), cancel: gettext('Cancel') });
