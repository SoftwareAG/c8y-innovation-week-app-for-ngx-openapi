...
class MapService {
    ...
    getLeaflet() {
        return __awaiter(this, void 0, void 0, function* () {
            const c8yLeafletInstance = (yield import('leaflet')).default;
    ...
    isPositionedDevice(mo) {
        return !!((mo === null || mo === void 0 ? void 0 : mo.c8y_IsDevice) && this.hasPosition(mo));
    }
    /**
     ...
     */
    hasPosition(mo) {
        return mo === null || mo === void 0 ? void 0 : mo.c8y_Position;
    }
    getPositionMOs(bound, byGroupIdMO) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getPositionMOsFromBound(bound, byGroupIdMO, false);
        });
    }
    getPositionMOsFromBoundCount(bound, byGroupIdMO) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getPositionMOsFromBound(bound, byGroupIdMO, true);
        });
    }
    getPositionDevices(pageSize = this.MAX_DEVICE_PER_CLUSTER, count) {
        return __awaiter(this, void 0, void 0, function* () {
            const { paging, data } = yield this.inventory.list({
    ...
    getPositionMOsFromBound(bound, byGroupIdMO, count = false) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getAllPositionsMOs(byGroupIdMO, pageSize = 500) {
        return __awaiter(this, void 0, void 0, function* () {
            const filter = {
                pageSize,
                withTotalPages: true,
            ...
            const { paging, data, res } = yield this.inventory.list(filter);
            return {
                res,
                paging: paging,
                data: data
    ...
    getClusterSize(bound) {
        return __awaiter(this, void 0, void 0, function* () {
            const count = yield this.getPositionMOsFromBoundCount(bound);
...
class MapComponent {
    ...
    findMarker(assetId) {
        return this.markers.find((marker) => { var _a; return ((_a = marker.asset) === null || _a === void 0 ? void 0 : _a.id) === assetId; });
    }
    ...
    ngOnChanges(changes) {
        var _a, _b, _c, _d;
        if (((_a = changes.assets) === null || _a === void 0 ? void 0 : _a.currentValue) && !((_b = changes.assets) === null || _b === void 0 ? void 0 : _b.firstChange)) {
            this.refreshMarkers();
        }
        if (((_c = changes.config) === null || _c === void 0 ? void 0 : _c.currentValue) && !((_d = changes.config) === null || _d === void 0 ? void 0 : _d.firstChange)) {
    ...
    addLayers() {
        ...
        const tileLayers = sortByPriority(flattenLayers).reduce((acc, layer) => {
            ...
            acc = Object.assign({ [layer.label]: tiles }, acc);
            return acc;
        }, {});
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: MapComponent, decorators: [{
        ...
        return [{ type: i1$1.ManagedObjectRealtimeService }, { type: MapService }, { type: Array, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
                        args: [MAP_TILE_LAYER]
...
class ClusterMapComponent extends MapComponent {
    ...
    ngOnChanges(changes) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function* () {
            if ((_a = changes.config) === null || _a === void 0 ? void 0 : _a.firstChange) {
                return;
            }
            if (((_b = changes.rootNode) === null || _b === void 0 ? void 0 : _b.previousValue) !== ((_c = changes.rootNode) === null || _c === void 0 ? void 0 : _c.currentValue)) {
                this.changeRootNode(changes.rootNode.currentValue);
            }
            if ((_d = changes.config) === null || _d === void 0 ? void 0 : _d.currentValue) {
                this.changeConfig(changes.config);
            }
        });
    }
    ...
    changeRootNode(mo) {
        ...
        this.clearMarkers();
        this.clearClusters();
        const isPositionDevice = (mo === null || mo === void 0 ? void 0 : mo.c8y_Position) && (mo === null || mo === void 0 ? void 0 : mo.c8y_IsDevice);
        if (isPositionDevice) {
            this.assets = mo;
            this.refreshMarkers();
            return;
    ...
    getClusterRects(levelThreshold = ClusterSize.FOUR, viewBounds, level = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (levelThreshold === ClusterSize.NONE) {
                const rect = yield this.getRect(viewBounds);
                rects.push(rect);
                return rects;
            }
            ...
            for (const bound of bounds) {
                ...
                const rect = yield this.getRect(latLngBound);
                rects = [...rects, ...(yield this.getClusterRects(levelThreshold, latLngBound, level))];
                if (level === levelThreshold) {
                    rects.push(rect);
                }
            }
    ...
    getRect(latLngBound) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.showClusterColor) {
                color = yield this.colorService.generateColor(latLngBound.toBBoxString());
            }
    ...
    updateCluster(cluster) {
        return __awaiter(this, void 0, void 0, function* () {
            const clusterCount = yield this.mapService.getPositionMOsFromBoundCount(cluster.rect.getBounds(), this.rootNode);
            ...
            cluster.positions = yield this.mapService.getPositionMOs(cluster.rect.getBounds(), this.rootNode);
            return cluster;
        });
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: ClusterMapComponent, decorators: [{
        ...
        return [{ type: i1$1.ManagedObjectRealtimeService }, { type: MapService }, { type: Array, decorators: [{
                        ...
                        type: Inject,
                        args: [MAP_DEFAULT_CONFIG]
                    }] }, { type: i3.TranslateService }, { type: i0.IterableDiffers }, { type: i1$1.ColorService }];
...
class MapStatusComponent {
    ...
    ngOnChanges(changes) {
        var _a, _b;
        if (((_a = changes.clusterMap) === null || _a === void 0 ? void 0 : _a.previousValue) !== ((_b = changes.clusterMap) === null || _b === void 0 ? void 0 : _b.currentValue)) {
    ...
    toggleRealtime() {
        this.config = Object.assign(Object.assign({}, this.config), { realtime: !this.config.realtime });
        this.configChange.emit(this.config);
    }
    unfollow() {
        this.config = Object.assign(Object.assign({}, this.clusterMap.config), { follow: false });
        this.configChange.emit(this.config);
        this.onUnfollow.emit(this.config);
    }
    follow() {
        this.config = Object.assign(Object.assign({}, this.config), { follow: true });
        this.configChange.emit(this.config);
    }
    ngOnDestroy() {
        this.destroy$.next();
