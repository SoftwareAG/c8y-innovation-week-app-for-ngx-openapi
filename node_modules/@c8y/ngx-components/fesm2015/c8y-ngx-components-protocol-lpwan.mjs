...
class SigfoxMultipleLnsConnectorComponent {
    ...
    resetEditedUnsavedConnection() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (index !== -1) {
                const originalData = (yield this.connectorService.detail(ConnectionType.SIGFOX, name));
    ...
    deleteConnection(originalConnection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.delete(originalConnection);
            }
            catch (error) {
                // empty catch block
            }
    ...
    saveConnection() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.connectorService.save(this.connection, (_a = this.originalConnection) === null || _a === void 0 ? void 0 : _a.name);
    ...
    delete(originalConnection) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.connectorService.delete(originalConnection);
...
class ActilityMultipleLnsConnectorComponent {
    ...
    resetEditedUnsavedConnection() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const index = findIndex(this.connections, { name });
            if (index !== -1) {
                const originalData = (yield this.connectorService.detail(ConnectionType.ACTILITY, name));
                this.connections[index] = originalData;
            }
        });
    }
...
class LoriotMultipleLnsConnectorComponent {
    ...
    loadConnections() {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.connectorService.list(ConnectionType.LORIOT);
            if (res && res.status !== 200) {
                const data = res.json ? yield res.json() : undefined;
                this.alertService.addServerFailure({ data, res });
                this.state = 'loadingError';
    ...
    resetEditedUnsavedConnection() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const index = findIndex(this.connections, { name });
            if (index !== -1) {
                const originalData = (yield this.connectorService.detail(ConnectionType.LORIOT, name));
                this.connections[index] = originalData;
            }
        });
    }
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            const checkForConnectionName = this.originalConnection && this.originalConnection.name && this.originalConnection.name !== ''
                ? this.originalConnection.name
                : this.connection.name;
            const isConnectionExist = yield this.connectorService.exists(ConnectionType.LORIOT, checkForConnectionName);
            if (this.state === 'addConnections' && isConnectionExist) {
    ...
    deleteConnection(originalConnection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.modal.confirm(gettext('Delete connection'), msg, Status.DANGER, {
                    ok: gettext('Delete'),
                    cancel: gettext('Cancel')
                });
                yield this.delete(originalConnection);
