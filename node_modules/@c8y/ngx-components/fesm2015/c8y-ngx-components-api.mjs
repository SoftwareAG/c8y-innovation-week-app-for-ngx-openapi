...
class HttpRequestHandler extends HttpHandler {
    ...
    handle(req) {
        ...
        (_a = this.apiService) === null || _a === void 0 ? void 0 : _a.onStart({ method, options, url });
        ...
        fetchPromise.then((response) => { var _a; return (_a = this.apiService) === null || _a === void 0 ? void 0 : _a.onFinish({ method, options, url, response }); }, (response) => { var _a; return (_a = this.apiService) === null || _a === void 0 ? void 0 : _a.onFinish({ method, options, url, response }); });
