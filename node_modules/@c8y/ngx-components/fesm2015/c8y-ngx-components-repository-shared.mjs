...
import { Injectable, Component, Input, EventEmitter, forwardRef, ViewChild, Output, NgModule } from '@angular/core';
import * as i1 from '@c8y/client';
import { Service, QueriesUtil, OperationStatus } from '@c8y/client';
import * as i2 from '@c8y/ngx-components';
import { gettext, memoize, ModalSelectionMode, PRODUCT_EXPERIENCE_EVENT_SOURCE, CoreModule, FormsModule, OperationRealtimeService } from '@c8y/ngx-components';
...
class AdvancedSoftwareService extends Service {
    ...
    isASMAvailable() {
        if (this.isAvailable === undefined) {
            this.isAvailable = this.appState.isApplicationAvailable(AdvancedSoftwareService.applicationName);
        }
        return this.isAvailable;
    }
}
AdvancedSoftwareService.applicationName = 'advanced-software-mgmt';
AdvancedSoftwareService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: AdvancedSoftwareService, deps: [{ token: i1.FetchClient }, { token: i2.AppStateService }], target: i0.ɵɵFactoryTarget.Injectable });
AdvancedSoftwareService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: AdvancedSoftwareService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: AdvancedSoftwareService, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: i1.FetchClient }, { type: i2.AppStateService }]; } });
...
FileDownloadComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: FileDownloadComponent, deps: [{ token: RepositoryService }, { token: i1.InventoryBinaryService }, { token: i2.AlertService }], target: i0.ɵɵFactoryTarget.Component });
FileDownloadComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.2.7", type: FileDownloadComponent, selector: "c8y-file-download", inputs: { url: "url" }, ngImport: i0, template: "<a\n  *ngIf=\"determineBehavior() === linkRenderType.LINK\"\n  href=\"{{ url }}\"\n  class=\"pointer\"\n  target=\"_blank\"\n  rel=\"noopener noreferrer\"\n>\n  {{ getBinaryName$(url) | async }}\n</a>\n\n<span *ngIf=\"determineBehavior() === linkRenderType.TEXTONLY\">{{\n  getBinaryName$(url) | async\n}}</span>\n\n<span *ngIf=\"determineBehavior() === linkRenderType.DOWNLOAD\">\n  <a *ngIf=\"!isDownloading\" class=\"pointer\" (click)=\"downloadFile()\">\n    {{ getBinaryName$(url) | async }}\n  </a>\n\n  <span *ngIf=\"isDownloading\">\n    <i c8yIcon=\"spinner\" class=\"icon-spin\"></i> {{ 'Downloading\u2026' | translate }}\n  </span>\n</span>\n", dependencies: [{ kind: "directive", type: i4.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i2.IconDirective, selector: "[c8yIcon]", inputs: ["c8yIcon"] }, { kind: "pipe", type: i4.AsyncPipe, name: "async" }, { kind: "pipe", type: i2.C8yTranslatePipe, name: "translate" }] });
__decorate([
    memoize(),
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: FileDownloadComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: RepositoryService }, { type: i1.InventoryBinaryService }, { type: i2.AlertService }]; }, propDecorators: { url: [{
                type: Input
...
RepositorySelectModalComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: RepositorySelectModalComponent, deps: [{ token: RepositoryService }, { token: i2$1.TranslateService }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: RepositorySelectModalComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: RepositoryService }, { type: i2$1.TranslateService }]; } });
...
SoftwareTypeComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: SoftwareTypeComponent, deps: [{ token: RepositoryService }, { token: i0.ChangeDetectorRef }, { token: i2$1.TranslateService }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: SoftwareTypeComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: RepositoryService }, { type: i0.ChangeDetectorRef }, { type: i2$1.TranslateService }]; }, propDecorators: { softwareTypeMO: [{
                type: Input
            }], disabled: [{
                type: Input
            }], style: [{
...
SharedRepositoryModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: SharedRepositoryModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
SharedRepositoryModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.7", ngImport: i0, type: SharedRepositoryModule, declarations: [RepositorySelectModalComponent, FileDownloadComponent, SoftwareTypeComponent], imports: [CommonModule, CoreModule, FormsModule, PopoverModule], exports: [RepositorySelectModalComponent, FileDownloadComponent, SoftwareTypeComponent] });
SharedRepositoryModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: SharedRepositoryModule, providers: [AdvancedSoftwareService, RepositoryService, OperationRealtimeService], imports: [CommonModule, CoreModule, FormsModule, PopoverModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: SharedRepositoryModule, decorators: [{
            type: NgModule,
            args: [{
...
export { AdvancedSoftwareService, DeviceConfigurationOperation, FileDownloadComponent, PRODUCT_EXPERIENCE, REPOSITORY_BINARY_TYPES, RepositorySelectModalComponent, RepositoryService, RepositoryType, SharedRepositoryModule, SoftwareTypeComponent };
