...
class ImageWidgetService {
    ...
    getImageDetails(imageBinaryId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!imageBinaryId) {
                return null;
            }
            try {
                const { data: imageBinaryMo } = yield this.inventory.detail(imageBinaryId);
                const file = yield this.fileService.getFile(imageBinaryMo);
                const base64 = yield this.fileService.toBase64(file);
                return {
                    file,
                    base64: base64
                };
    ...
    uploadFile(file, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const hash = yield this.fileService.getHashSumOfFile(file);
            const fileDetails = { c8y_SHA256: hash };
            const globalImage = !(options === null || options === void 0 ? void 0 : options.dashboardMoId) || (options === null || options === void 0 ? void 0 : options.isDeviceTypeDashboard);
            const partialBinaryMo = !globalImage
                ? Object.assign({}, fileDetails) : Object.assign(Object.assign({}, fileDetails), { c8y_Global: {} });
            const { data: mo } = yield this.binary.create(file, partialBinaryMo);
            if (options === null || options === void 0 ? void 0 : options.dashboardMoId) {
                yield this.inventory.childAdditionsAdd(mo, options === null || options === void 0 ? void 0 : options.dashboardMoId);
            }
            return mo.id;
        });
    }
    getStyling(config) {
        var _a, _b, _c, _d;
        if (!((_a = config.styling) === null || _a === void 0 ? void 0 : _a.objectFit) || ((_b = config.styling) === null || _b === void 0 ? void 0 : _b.objectFit) === 'full-width') {
            return null;
        }
        return {
            'object-fit': config.styling.objectFit,
            'object-position': `${((_c = config.styling) === null || _c === void 0 ? void 0 : _c.objectPositionX) || defaultObjectPositionValue} ${((_d = config.styling) === null || _d === void 0 ? void 0 : _d.objectPositionY) || defaultObjectPositionValue}`
        };
    }
}
...
class ImageWidgetConfigComponent {
    ...
    onBeforeSave(config) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (fileFromForm && fileFromForm !== this.fileFromConfig) {
                try {
                    const imageBinaryId = yield this.imageWidget.uploadFile(fileFromForm, {
                        dashboardMoId: this.getDashboardMoId(),
                        isDeviceTypeDashboard: (_a = this.widgetConfig) === null || _a === void 0 ? void 0 : _a.isDeviceTypeDashboard
                    });
                    Object.assign(config, { imageBinaryId });
                }
                catch (e) {
                    this.alert.danger(gettext('Unable to upload image.'), e === null || e === void 0 ? void 0 : e.data);
                    return false;
                }
            }
    ...
    ngOnInit() {
        ...
        }), map(details => details === null || details === void 0 ? void 0 : details.base64), shareReplay(1));
        ...
        this.imageBinaryId$.next((_a = this.config) === null || _a === void 0 ? void 0 : _a.imageBinaryId);
    }
    ngOnDestroy() {
        this.destroyed$.next();
    ...
    getFileFromFormValue(formValue) {
        var _a;
        const images = (formValue === null || formValue === void 0 ? void 0 : formValue.images) || [];
        return ((_a = images[0]) === null || _a === void 0 ? void 0 : _a.file) || null;
    }
    setStyling(config) {
        this.styling = this.imageWidget.getStyling(config);
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: ImageWidgetConfigComponent, decorators: [{
        ...
        return [{ type: i1$1.FormBuilder }, { type: i1$1.NgForm }, { type: i2.FilesService }, { type: i2.AlertService }, { type: ImageWidgetService }, { type: i4.WidgetConfigComponent, decorators: [{
                        type: Optional
                    }] }];
