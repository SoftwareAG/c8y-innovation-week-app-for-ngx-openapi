...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: SearchGridComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: AssetSearchService }, { type: i2$1.BsModalService }, { type: i3$1.SmartGroupsService }, { type: i4.SubAssetsService }, { type: undefined, decorators: [{
                    type: Optional
                }, {
                    type: Inject,
                    args: [SEARCH_CONFIG]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.7", ngImport: i0, type: SearchActionComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.RouterService }, { type: i1$2.Router }, { type: undefined, decorators: [{
                    type: Optional
                }, {
                    type: Inject,
                    args: [SEARCH_CONFIG]
