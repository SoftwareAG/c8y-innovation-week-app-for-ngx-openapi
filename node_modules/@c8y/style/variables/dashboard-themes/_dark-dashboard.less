...
.c8y-grid-dashboard c8y-dashboard-child .panel-content-dark {
  ...
  --c8y-palette-gray-100: #011f3d;
  --c8y-palette-gray-90: #07284b;
  --c8y-palette-gray-80: #253c62;
  --c8y-palette-gray-70: #36597d;
  --c8y-palette-gray-60: #7d8698;
  --c8y-palette-gray-50: #a7acb9;
  --c8y-palette-gray-40: #d2d9e0;
  --c8y-palette-gray-30: #e7ebee;
  --c8y-palette-gray-20: #f0f2f4;
  --c8y-palette-gray-10: #f9fafb;
  --c8y-palette-low: #011932;
  ...
  --c8y-action-bar-background-default: var(--c8y-palette-gray-100);
  ...
  --c8y-brand-complementary: var(--brand-complementary, var(--c8y-palette-teal-80));
  --c8y-brand-dark: var(--brand-dark, var(--c8y-palette-teal-10));
  --c8y-brand-light: var(--brand-light, var(--c8y-palette-teal-50));
  --c8y-brand-primary: var(--brand-primary, var(--c8y-palette-teal-30));
  --c8y-brand-80: var(--c8y-palette-teal-10);
  --c8y-brand-70: var(--c8y-palette-teal-20);
  --c8y-brand-60: var(--c8y-palette-teal-30);
  --c8y-brand-50: var(--c8y-palette-teal-40);
  --c8y-brand-40: var(--c8y-palette-teal-50);
  --c8y-brand-30: var(--c8y-palette-teal-60);
  --c8y-brand-20: var(--c8y-palette-teal-70);
  --c8y-brand-10: var(--c8y-palette-teal-80);
  ...
  --c8y-form-control-color-disabled: var(
    --c8y-component-color-disabled,
    var(--c8y-root-component-color-disabled)
  );
  --c8y-form-control-background-focus: var(
    --c8y-component-background-default,
    var(--c8y-root-component-background-default)
  );
  --c8y-form-control-background-default: var(
    --c8y-component-background-default,
    var(--c8y-root-component-background-default)
  );
  ...
  --c8y-btn-primary-background-focus: var(
    --c8y-component-background-default,
    var(--c8y-root-component-background-default)
  );
  --c8y-btn-primary-background-hover: var(
    --c8y-component-background-default,
    var(--c8y-root-component-background-default)
  );
  ...
  --c8y-root-component-form-control-border-color-default: var(
    --c8y-form-control-border-color-default
  );
  --c8y-root-component-form-control-background-disabled: var(
    --c8y-form-control-background-disabled
  );
  ...
  --c8y-root-component-scrollbar-track: var(
    --c8y-component-background-default, var(--c8y-root-component-background-default));
  ...
  --c8y-root-component-background-expanded-gradient: linear-gradient(
    0deg,
    rgba(255, 255, 255, 0.03) 0px,
    var(--c8y-root-component-background-expanded) 12px,
    var(--c8y-root-component-background-expanded) calc(100% - 12px),
    rgba(0, 0, 0, 0.03) 100%
  );
