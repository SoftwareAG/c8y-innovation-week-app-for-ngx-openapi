...
.c8y-grid-dashboard c8y-dashboard-child .panel-content-white {
  ...
  --c8y-global-odd: linear-gradient(to top, rgba(0, 0, 0, .03), rgba(0, 0, 0, 0.03));
  ...
  --c8y-switch-background-active: var(--c8y-brand-50);
...
.dashboard-preview-slot.dashboard-theme-light {
  --c8y-dashboard-background: var(--c8y-body-background-color);
  background: white !important;
  ...
  // TODO: Uncomment when the dark theme is available
